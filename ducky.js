window.onload = function () {
  ...
  function moveDuck(aDuck) {
   aDuck.style.top = (Math.random() * window.innerHeight) + 'px';
   aDuck.style.left = (Math.random() * window.innerWidth) + 'px';
  }

  // 4. Try making the duck move to a different location every second (what did we use to do this several lines up??)

  setInterval(function () { moveDuck(newDiv1) }, 1000);
